...
number_of_configurations = 40
attribute_range_values = (('nConvLayers', 3, 2, 6),
                          ('kernelSize', 58, 8, 60),
                          ('stride', 1, 1, 1),
                          ('constraint', 3, 3, 3),
                          ('nInitialFilters', 39, 32, 128),
                          ('batchSize', 69, 20, 80),
                          ('nDenseUnits', 73, 64, 80),
                          ('dropout_rate1', 0.52, 0.4, 0.6),
                          ('dropout_rate2', 0.68, 0.3, 0.8))
...
# MULTIPLICATIONS
# =============================================================================
multiplication_factor = 20  # koliko puta da se puta daju isti podaci koji su zasumljeni
noise = 0.01  # odnos odataog suma i postojeceg signala

number_of_taps_in_measurements = 10 # merenja se odmah dele na tapove. Ukoliko se stavi None onda se uyima citav signal i parametar stride se ne koristi
stride_for_taps_in_measurements = 5  # ukoliko se uzimaju tapovi za koliko da se pomere od pocetka prehodnog.
...
number_of_tests = 5  # koliko razlicitih odabiranja pacijenata da se koristi
...
splits_file = './integralSplits.txt'  # fajl sa odredjenim granicama tapova
result_in_csv = False
